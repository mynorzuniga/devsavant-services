// Nav: white pill floating at top. DevSavant + AI Governance lockup, anchor links, CTA.
function Nav() {
  const links = [
    { label: 'The model', href: '#pillars' },
        ...
        <div style={{ pointerEvents: 'auto' }}>
          <Container max={1260} style={{ pointerEvents: 'auto' }}>
            <nav style={{
              ...
              <a href="#top" onClick={closeMenu} style={{ display: 'flex', alignItems: 'center', gap: 12, textDecoration: 'none', lineHeight: 1, borderBottom: 'none' }}>
          ...
          {links.map(l => (
            <a key={l.label} href={l.href} onClick={closeMenu}
              style={{
                ...
                color: 'var(--ds-ink)', textDecoration: 'none', borderBottom: '1px solid var(--ds-ink-06)',
              }}
            >{l.label}</a>
          ))}
        </div>
